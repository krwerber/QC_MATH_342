...
```{r}
set = list("M" = list("Boomer" = strsplit("Theodore, Bernard, Gene, Herbert, Ray, Tom, Lee, Alfred, Leroy, Eddie", split = ", ")[[1]],
           ...
           "F" = list("Boomer" = strsplit("Gloria, Joan, Dorothy, Shirley, Betty, Dianne, Kay, Marjorie, Lorraine, Mildred", split = ", ")[[1]],
...
#TO-DO
v = seq(-100, 100)
testthat::expect_equal(v, -100 : 100)
```
...
my_reverse = function(v){
  rev_v = v[seq(length(v), 1, by = -1)]
}
v = c("A", "B", "C")

testthat::expect_equal(my_reverse(v), rev(v))
testthat::expect_equal(my_reverse(c("A", "B", "C")), c("C", "B", "A"))
```
